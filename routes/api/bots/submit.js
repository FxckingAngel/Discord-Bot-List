...
const checkFields = require('/home/runner/Discord-Bot-List/utils/checkFields');
...
route.post("/:id", auth, async (req, res) => {
    ...
    try {
        await req.app.get('client').channels.cache.find(c => c.id === server.mod_log_id).send(`</home/runner/Discord-Bot-List/${req.user.id}> ${resubmit ? "re" : ""}submitted </home/runner/Discord-Bot-List/${req.params.id}>: </home/runner/Discord-Bot-List/&${server.role_ids.bot_verifier}>`);
