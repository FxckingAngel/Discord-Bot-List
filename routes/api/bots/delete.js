...
route.delete("/:id", auth, async (req, res) => {
    ...
    req.app.get('client').channels.cache.get(server.mod_log_id).send(`</home/runner/Discord-Bot-List/${req.user.id}> has deleted </home/runner/Discord-Bot-List/${bot.botid}>`);
