...
const { web: {domain_with_protocol}, server: {id} } = require("/home/runner/Discord-Bot-List/config.json");
...
route.get("/:id", async (req, res) => {
  ...
  try {
    ...
    let verified = await resolveImage(path.join(__dirname, "/home/runner/Discord-Bot-List/verified_badge.png"));
